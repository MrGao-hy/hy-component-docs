...
|--------------|-----------------------------|------------------------------------------------------------|---------|--------------------------------------------|
| text         | 标签的文字内容                     | `string`                                                   | -       | -                                          |
| type         | 主题类型                        | `error` \|  `warning` \|  `success` \| `primary` \| `info` | primary | primary / success / info / warning / error |
| disabled     | 禁用                          | `boolean`                                                  | false   | -                                          |
| size         | 标签大小                        | `small` \| `medium` \| `large`                             | medium  | 可选值为 large，medium，small                    |
| shape        | 标签形状                        | ``                                                         | square  | circle / square                            |
...
| autoBgColor  | 自动根据color计算浅色背景色            | `number`                                                   | 85      | 0-100                                      |
