...
| previousMargin         | 前边距，可用于露出前一项的一小部分，nvue和支付宝不支持，数值默认单位px                    | `string` \| `number`                                                  | 0                         |
| nextMargin             | 后边距，可用于露出后一项的一小部分，nvue和支付宝不支持，数值默认单位px                    | `string` \| `number`                                                  | 0                         |
...
| height                 | 组件高度，数值默认单位px                                                                  | `string` \| `number`                                                  | 130                       |
| bgColor                | 背景颜色                                                                                  | `string`                                                              | -                         |
| radius                 | 组件圆角，数值默认单位px                                                                  | `string` \| `number`                                                  | 4                         |
